...
python -m submit_dd_jobs --debug=True --dataset=schellma:run5141Prod2Reco --query_limit=10 -c eventdump.fcl -n 1 --njobs=1  --load_limit=1 --appFamily=LArSoft --appName=eventdump --appVersion=${DUNESW_VERSION} --blacklist=Swan
